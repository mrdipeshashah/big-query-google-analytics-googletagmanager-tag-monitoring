...
3. The one addition the dashboard will need is adding in Health Status in the detailed log, Add Field > Add Calculated Field > Label Health Status > Copy the below and change the tag name and requirements
